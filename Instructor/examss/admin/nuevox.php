...
?>
<div class="col-md-10" style="margin-top: 60px; margin-left: 60px;">
...
?>
    ...
    <tr>
      <td class="danger">Primer Apellido:</td>
      <td><input type="text" name="ap" class="form-control" ></td>
      <td class="danger">Segundo Apellido:</td>
